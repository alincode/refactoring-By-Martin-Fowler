...
public class MovieTest {
    ...
    public void testGetCharge1() throws Exception {
        assertEquals(12.0, m1._price.getCharge(4), 0);
    }

    @Test
    public void testGetCharge2() throws Exception {
        assertEquals(6.5, m2._price.getCharge(5), 0);
    }

    @Test
    public void testGetCharge3() throws Exception {
        assertEquals(7.5, m3._price.getCharge(7), 0);
    }

    @Test
    public void testGetCharge4() throws Exception {
        assertEquals(6.0, m1._price.getCharge(2), 0);
    }

    @Test
    public void testGetCharge5() throws Exception {
        assertEquals(1.5, m3._price.getCharge(3), 0);
    }
